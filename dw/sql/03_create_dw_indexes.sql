...
ON dw.dim_cliente (id_cliente_natural, es_actual);

CREATE INDEX IF NOT EXISTS idx_dim_producto_actual
ON dw.dim_producto (id_producto_natural, es_actual);
-----------------------------------------------------
CREATE INDEX IF NOT EXISTS idx_dim_cliente_vigencia
ON dw.dim_cliente (id_cliente_natural, fecha_inicio_vigencia, fecha_fin_vigencia);
